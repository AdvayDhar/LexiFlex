    ...
    return (
        <>
            ...
            {!translating && (<div className='flex flex-col gap-1 mb-4'>
                <p className='text-red-400 text-xs sm:text-sm font-medium text-slate-500 mr-auto'>To language</p>
                <div className='text-blue-400 flex items-stretch gap-2 sm:gap-4' >
                    <select value={toLanguage} className='text-blue-400 flex-1 outline-none w-full focus:outline-none bg-white duration-200 p-2  rounded' onChange={(e) => setToLanguage(e.target.value)}>
